  ...
  return (
    <div className='flex flex-col md:flex-row gap-5 border p-4 bg-gray-900 rounded-lg'>
        ...
        <Link to={`/link/${url?.id}`} className='flex flex-col flex-1'>
            ...
            <span className="text-2xl font-bold text-blue-400 hover:underline cursor-pointer">https://trimrr.in/{url?.custom_url ? url?.custom_url : url?.short_url}</span>
            <span className="text-2xl items-center gap-1  hover:underline cursor-pointer">{url?.original_url}</span>
